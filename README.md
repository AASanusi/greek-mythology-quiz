...
HTML and CSS3 technologies were used to creeate the general structure and design of the website. JavaScript technology was used to bring the website alive making it interactive for the users to use and play.
...
- ### User Stories
  - #### First Time User
    ...
    - As a First Time User, I want to know in real time if my answer selections are correct or incorrect.
   ...
   - #### Consistent User
     ...
     - As a Consistent User, I want to access the homepage at anytime during the quiz.
     - As a Consistent User, I want to be able to access the scores table from the homepage.

## Features
Each individual feature on this quiz site was designed to make it easy for the users to navigate this site without running into any issues. This site is made up of clickable button that ranges in accessibility to either direct the users to the quiz page, home page, the highscore page and to answering the questions asked on the quiz page.

- ### Existing Features
  - #### Header
    - This consists of the heading of the page which provides details on what the site is. This heading lets the user know that this is a Greek Mythology Quiz site.
    - The header can be clicked at anytime and will direct user back to the home page. This provides the user the option to quit the game at any given time and return to the homepage.
...
![Screenshot of the header](assets/images/header-screenshot.png)
  ...
  - #### Home Page
    ...
    - The home page consists of welcoming message that informs the user about the page and urges the user to challenge their knowledge on Greek Mythology.
    - The home page also consists of two clickable buttons: "Test Yourself!" and "High Scores" buttons. Both buttons has hover to ensure the user knows which button they are about to click. Both buttons increase in size and highlighted with a shadow of their respective colour when hovered over.
...
![Screenshot of the homepage](assets/images/homepage-screenshot.png)  
  ...
  - #### Quiz Page
    ...
    - The quiz page consists of the question which is captured in blue writing and the four answer choice buttons in blue with white writing.
    - Each answer button increases in size and highlights with a shadow of their respective colour when hovered over.
    - When user clicks one of the button, it will either turn "red" meaning incorrect answer or turn "green" for correct. After each selection, the page moves on to the next question until reaching the endpoint.
...
![Screenshot of the Quiz Page](assets/images/quiz-page-screenshot.png)  
  ...
  - #### Endpoint Page
      - After completing all questions, user is taken to the endpoint page of the quiz. Endpoint is aesthically similar to the other pages.
      - The endpoint page shows the user's score at the top with a message below informing the user they've reached the end of the game.
      - Below the score and endpoint message is another message that informs the user to input their name in the box provided to save their scores. The box has a placeholder to prompt the user to enter their name in the box.
      - Below the input box, there are 3 buttons: "Save" button, "Restart!" button and "Home Page" button. The "Save" button allows the users to save their details and scores to which then takes them to the High Score page once clicked. "Restart!" button allows user to start quiz over."Home Page" when clicked will take the user back to the home page.

![Screenshot of the Endpoint Page](assets/images/endpoint-screenshot.png)  

  - #### Highscores Page
      - The highscores page consists of the scores tables.
...
- ### Future Implementation
  ...
  - #### Sharing scores
      - Provide a button to be able to share scores to social media. This will allow users to show off their scores online. Doing this will also bring traction to the site as it will pique the interest of people online.

## Design
  - ### Typography 
      - The Arvo family font is the main font used for the header, questions and all headings across the page. This font gives a Greek aesthic feel to the elements.
  ...
  - ### Colour Layout
      - The colour idea came from the website [ColorSpace](https://mycolor.space/), this generates complementary colours to use on the site.
      ...
      - There are other colours that feature on the site: black for the display progression question text, the actual score text and the message to inform the user to enter details. There's also a brown-reddish colour used for the score details on the highscore page.    
...
## Testing
  ...
  - ### Manual Testing
    - Manual editing was carried on each button and functionality to ensure a smooth running of the quiz. Header links opens to the home page correctly. The buttons all work and open correctly. The answer buttons show incorrect and correct answers. The save button save user details correctly to the high scores page.
 ...
 ### Bugs Encountered And Solution:
   - #### Bugs   
       - The answer buttons were showing up as undefined instead of the answers.
   - #### Solution   
...
### How to Fork a repository
  ...
  - Direct your attention to the top right corner of the repository page and locate the "Fork" button.
...
### How to Clone a repository
  ...
  - Pop up box appears with a URL to which you copy this URL for the repository. There are options to clone the repositiory using HTTPS, SSH key and Github CLI. Choose the relevant one for you, in this case it would be HTTPS tab.
...
### Media
  - No photos were used for this project has most of the website consists of buttons for the quiz.
...
### Code
  ...
  - [Brian Design Youtube Tuorial](https://www.youtube.com/watch?v=f4fB9Xg2JEY) aided in forming parts of HTML, CSS and JavaScript code alongside with my code.
...
### Acknowledgement 
  ...
  - #### Tutor
       ...
       - I would like to thank John for helping me out with solving my errors from Jshint.

  - #### Mentor
       - I would like to thank my mentor for providing me resources that helped me build my project.
       - I would like to thank my mentor for the continuous help and feedback on my project.
       - I would like to thank my mentor for continuoisly pushing me.
